defmodule SampleGrpc.UserReply do
  @moduledoc false
...
defmodule SampleGrpc.CreateRequest do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule SampleGrpc.GetRequest do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule SampleGrpc.User.Service do
  ...
  rpc :Get, SampleGrpc.GetRequest, SampleGrpc.UserReply
end

defmodule SampleGrpc.User.Stub do
  @moduledoc false
  use GRPC.Stub, service: SampleGrpc.User.Service
end
